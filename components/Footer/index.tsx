...
import { footerQuickLinks, services, supportLinks } from "../Utils/data";
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link
                  href="/"
                  className="mb-4 block flex w-full  exs:max-h-[90px]  exs:max-w-[90px] md:max-h-[90px] md:max-w-[140px]"
                >
                  <Image
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Innovation Partner for your Business Needs
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  {footerQuickLinks.map((each) => {
                    return (
                      <li key={each.linkHref}>
                        <a
                          href={each.linkHref}
